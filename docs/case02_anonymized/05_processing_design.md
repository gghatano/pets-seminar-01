...
!!! tip "k-匿名性と特異値 — なぜ丸めるのか"
    生年月日・住所・性別などの**準識別子を細かく残すと、「その組合せに1人しかいない」人が再識別**されます。そこで、**同じ属性の組合せを持つ人が最低 k 人はいる**状態（k-匿名性）を目指して丸めます（年代7区分・市区郡・分単位）。
...
<tr><td>生年月日</td><td>中</td><td>超高齢は高</td><td>年代で有用</td><td class="cell-chg">年代7区分へ丸め</td><td><span class="vol">5号措置</span> <span class="rule">4号</span></td><td>準識別子を丸め群を大きく。超高齢は特異値として対処</td></tr>
...
!!! warning "匿名加工の根拠は「作成基準（施行規則34条）」に沿う"
    ...
    - **5号**: データベースの性質を踏まえたその他の措置（丸めの水準は **k-匿名性**を見て判断）
